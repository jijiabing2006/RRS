...
public class JdbcDao extends SimpleJdbcTemplate{
	 ...
	 * @return bean对象
	 */
	public Object findForObject(String sql,Class clazz,Object[] parameters){
	 ...
	 * @return bean对象
	 */
	public long findForLong(String sql,Object[] parameters){
	...
	public Long getCountForJdbc(String  sql) {
		return  super.findForLong(sql,null);
	}
	/**
	...
	public Integer countByJdbc(String sql, Object... param) {
		return this.findForInt(sql, param);
	}
