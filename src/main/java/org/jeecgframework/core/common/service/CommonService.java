...
public interface CommonService {
	...
	public <T>T getUniqueResultByCriteriaQuery(CriteriaQuery cq);

	public <T>List<T> getFieldValueByWhere(Class<T> entityClass, String fieldname,
			String whereql, Object[] queryParams);
	public <T> T getMaxFieldValueByWhere(Class<T> entityClass, String fieldname,
			String whereql, Object[] queryParams);

	public <T>List<Object[]> queryFieldValues(Class<T> entityClass, String[] queryfields,
