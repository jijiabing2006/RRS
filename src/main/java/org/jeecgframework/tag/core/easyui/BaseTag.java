...
/*//			update-start--Author:longjb  Date:20150408 for：手动设置指定属性主题优先
			...
			if (oConvertUtils.isIn("jquery-webos", types)) {
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery-1.12.0.min.js\"></script>");
...
//				sb.append("<link id=\"easyuiTheme\" rel=\"stylesheet\" href=\"plug-in/easyui/themes/"+cssTheme+"/easyui.css\" type=\"text/css\"></link>");
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui/jquery.easyui.min.1.4.4.js\"></script>");
			...
			if (oConvertUtils.isIn("select2", types)) {
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/select2-4.0.0/css/select2.min.css\" type=\"text/css\"></link>");
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/select2-4.0.0/css/select2-bootstrap.min.css\" type=\"text/css\"></link>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/select2-4.0.0/js/select2.min.js\"></script>");
				sb.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/select2-4.0.0/js/i18n/{0}.js\"></script>", "{0}", lang));	
			}
			...
			if (oConvertUtils.isIn("designer", types)) {
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/designer/easyui/jquery.easyui.min.1.4.4.js\"></script>");
