...
public class CgformFtlController extends BaseController {
	...
	public ModelAndView addorupdate(CgformFtlEntity cgformFtl,
		...
		sb.append("</style></head><script type=\"text/javascript\" src=\"plug-in/jquery/jquery-1.12.0.min.js\">");
		...
		sb.append("src=\"plug-in/Validform/js/Validform_v5.3.2_min_zh-cn.js\"></script><script type=\"text/javascript\" ");
