...
//			htmlStr = matcher.replaceAll(""); 
	    	...
	    	ls_include.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery-1.12.0.min.js\"></script>");
	    	...
	    	ls_include.append("<script type=\"text/javascript\" src=\"plug-in/easyui/jquery.easyui.min.1.4.4.js\"></script>");
	    	...
	    	ls_include.append("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_v5.3.2_min_zh-cn.js\"></script>");
