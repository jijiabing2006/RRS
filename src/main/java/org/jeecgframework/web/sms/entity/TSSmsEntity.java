...
public class TSSmsEntity implements java.io.Serializable {
	...
	/**抄送人*/
	@Excel(name="抄送人")
	private java.lang.String esCopyer;
	/**内容*/
	@Excel(name="内容")
	 ...
	 */
	@Column(name ="ES_SENDER",nullable=true,length=255)
	 ...
	 */
	@Column(name ="ES_RECEIVER",nullable=true,length=255)
	 ...
	 */
	@Column(name ="ES_COPYER",nullable=true,length=255)
	public java.lang.String getEsCopyer() {
		return esCopyer;
	}

	public void setEsCopyer(java.lang.String esCopyer) {
		this.esCopyer = esCopyer;
	}
