 ...
 */
@Entity
@Table(name = "t_acc_cust", schema = "")
@SuppressWarnings("serial")
public class AccCustEntity implements java.io.Serializable {
	/** 主键 */
	...
	/** 外管账户性质代码 */
	@Excel(name = "外管账户性质代码")
	private java.lang.String safeAccType;
	 ...
	 * 方法: 取得java.lang.String
	 * 
	 * @return: java.lang.String 外管账户性质代码
	 */
	@Column(name = "SAFE_ACC_TYPE", nullable = true, length = 200)
	public java.lang.String getSafeAccType() {
		return safeAccType;
	}
	 ...
	 * 方法: 设置java.lang.String
	 * 
	 * @param: java.lang.String 外管账户性质代码
	 */
	public void setSafeAccType(java.lang.String safeAccType) {
		this.safeAccType = safeAccType;
	}
