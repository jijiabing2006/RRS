 ...
 */
@Entity
@Table(name = "jsh_f", schema = "")
@SuppressWarnings("serial")
@Inheritance(strategy = InheritanceType.JOINED)
public class JshFEntity extends SafeBaseEntity implements java.io.Serializable {
	/**外汇局批件号*/
	@Excel(name="外汇局批件号")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  结汇用途
	 */
	@Column(name ="USETYPE",nullable=true,length=3)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  结汇详细用途
	 */
	@Column(name ="USEDETAIL",nullable=true,length=100)
