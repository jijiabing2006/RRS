...
<t:formvalid formid="formobj" dialog="false" layout="div" btnsub="btn" 
	action="accController.do?exportReport">
	<input type="hidden" id="id" />
	<fieldset class="step">
		<div class="form">
			<div class="text_success">
				<label class="Validform_label"> 营业日期： </label>
				 <input name="dealdate" type="text" datatype="*" required="required"
					id="dealdate"> <span class="Validform_checktip"></span>
			</div>

			<div class="button-row">
				<a href="#" class="button" style="background:url('plug-in/easyui/themes/icons/share.png') no-repeat; background-position:5px;text-indent:10px;"
...
function exportReport() {
	...
	doSubmitNunTable("accController.do?exportReport&date="+d,"formobj");
}
...
$("#dealdate").focus( function() {
	...
	doSubmitNunTable("accController.do?dealDateCheck&date="+d,"formobj");
});
 </script>