...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bopSController.do?doAdd" tiptype="1"
  beforeSubmit="check(curform,'S');">
					<input id="id" name="id" type="hidden" value="${bopSPage.id }">
					<input id="buscode" name="buscode" type="hidden" value="${bopSPage.buscode }">
					<input id="cap" name="cap" type="hidden" value="${bopSPage.cap }">
					<input id="brca" name="brca" type="hidden" value="${bopSPage.brca }">
					<input id="importdate" name="importdate" type="hidden" value="${bopSPage.importdate }">
					<input id="isdel" name="isdel" type="hidden" value="${bopSPage.isdel }">
					<input id="isedit" name="isedit" type="hidden" value="${bopSPage.isedit }">
					<input id="isexport" name="isexport" type="hidden" value="${bopSPage.isexport }">
					<input id="ishandadd" name="ishandadd" type="hidden" value="${bopSPage.ishandadd }">
					<input id="isvalidation" name="isvalidation" type="hidden" value="${bopSPage.isvalidation }">
					<input id="filename" name="filename" type="hidden" value="${bopSPage.filename }">
					<input id="isinsafe" name="isinsafe" type="hidden" value="${bopSPage.isinsafe }">
					<input id="tfilename" name="tfilename" type="hidden" value="${bopSPage.tfilename }">
					<input id="remark" name="remark" type="hidden" value="${bopSPage.remark }">
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="actiontype" type="list"
									typeGroupCode="actiontype" defaultVal="${bopSPage.actiontype}" hasLabel="false"  title="操作类型"></t:dictSelect>     
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="isref" type="list"
									typeGroupCode="sf_YN" defaultVal="${bopSPage.isref}" hasLabel="false"  title="是否保税货物项下"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="country" type="list"
									dictTable="s_p_countrycode" dictField="code" dictText="text" defaultVal="${bopSPage.country}" hasLabel="false"  title="收款人常驻国家地区代码"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							  <t:dictSelect field="payattr" type="list"
									typeGroupCode="domesticpayattr" defaultVal="${bopSPage.payattr}" hasLabel="false"  title="境内收入类型"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="paytype" type="list"
									typeGroupCode="paytype" defaultVal="${bopSPage.paytype}" hasLabel="false"  title="付款类型"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							  <t:dictSelect field="txcode" type="list"
									dictTable="s_p_transcationcode where dir='2'" dictField="code" dictText="text" defaultVal="${bopSPage.txcode}" hasLabel="false"  title="交易编码1"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="txcode2" type="list"
									dictTable="s_p_transcationcode where  dir='2'" dictField="code" dictText="text" defaultVal="${bopSPage.txcode2}" hasLabel="false"  title="交易编码2"></t:dictSelect>     
							<span class="Validform_checktip"></span>
