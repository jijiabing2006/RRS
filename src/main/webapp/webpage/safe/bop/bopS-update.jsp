		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="actiondesc" name="actiondesc"
					...
					value='${bopSPage.actiondesc}" > <span
					class="Validform_checktip"></span></td>
				...
				<td class="value"><input id="rptno" name="rptno" type="text"
					...
					value='${bopSPage.rptno}" > <span class="Validform_checktip"></span>
				</td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label">
				...
				<td class="value"><t:dictSelect field="country" type="list"
						...
						defaultVal="${bopSPage.country}" hasLabel="false"
						title="收款人常驻国家地区代码" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">付款类型 </label></td>
				<td class="value"><t:dictSelect field="paytype" type="list"
						typeGroupCode="paytype" defaultVal="${bopSPage.paytype}"
						hasLabel="false" title="付款类型" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 付汇性质 </label></td>
				<td class="value"><t:dictSelect field="payattr" type="list"
						typeGroupCode="domesticpayattr" defaultVal="${bopSPage.payattr}"
						hasLabel="false" title="付汇性质" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">境内收入类型</label></td>

			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 交易编码1
				</label></td>
				<td class="value"><t:dictSelect field="txcode" type="list"
						dictTable="s_p_transcationcode where dir='2'" dictField="code"
						dictText="text" defaultVal="${bopSPage.txcode}" hasLabel="false"
						title="交易编码1" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 相应金额1
				</label></td>
				<td class="value"><input id="tc1amt" name="tc1amt" type="text"
					 class="inputxt" datatype="integer"
					value='${bopSPage.tc1amt}" > <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 外汇局批件号
				</label></td>
				<td class="value"><input id="regno" name="regno" type="text"
					 class="inputxt" value="${bopSPage.regno}" >
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 交易编码2
				</label></td>
				<td class="value"><t:dictSelect field="txcode2" type="list"
						dictTable="s_p_transcationcode where  dir='2'" dictField="code"
						dictText="text" defaultVal="${bopSPage.txcode2}" hasLabel="false"
						title="交易编码2" ignore="ignore" datatype="duplicate,linkcheck"
						with="duplicate:txcode,linkcheck:tc2amt#empty#false"></t:dictSelect>
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 相应金额2
				</label></td>
				<td class="value"><input id="tc2amt" name="tc2amt" type="text"
					 class="inputxt" value="${bopSPage.tc2amt}" 
					ignore="ignore" datatype="integer,linkcheck"
					with="txcode2#empty#false">
					<span class="Validform_checktip"></span></td>
					<td align="left"><label class="Validform_label">
						是否保税货物项下 </label></td>
				<td class="value"><t:dictSelect field="isref" type="list"
						typeGroupCode="sf_YN" defaultVal="${bopSPage.isref}"
						hasLabel="false" title="是否保税货物项下" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 合同号 </label></td>
				<td class="value"><input id="contrno" name="contrno"
					type="text"  class="inputxt" datatype="*"
					value='${bopSPage.contrno}" > <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 发票号 </label></td>
				<td class="value"><input id="invoino" name="invoino"
					type="text"  class="inputxt" datatype="*"
					value='${bopSPage.invoino}" > <span
					class="Validform_checktip"></span></td>
						<td colspan="2" rowspan="2" style="background:white;"><span
					id="showremark" style="color:red;" type="hidden"> </span></td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 提运单号 </label></td>
				<td class="value"><input id="billno" name="billno" type="text"
					 class="inputxt" value="${bopSPage.billno}" >
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 合同金额 </label></td>
				<td class="value"><input id="contamt" name="contamt"
					type="text"  class="inputxt"
					value='${bopSPage.contamt}"  ignore="ignore" datatype="integer"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 填报人 </label></td>
				<td class="value"><input id="crtuser" name="crtuser"
					type="text"  class="inputxt" datatype="*"
					value='${bopSPage.crtuser}" > <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 填报人电话
				</label></td>
				<td class="value"><input id="inptelc" name="inptelc"
					type="text"  class="inputxt" datatype="*"
					value='${bopSPage.inptelc}" > <span
					class="Validform_checktip"></span></td>
				...
				<td class="value"><input id="rptdate" name="rptdate"
					...
					value='<fmt:formatDate value="${bopSPage.rptdate}"  type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span></td>
			</tr>
		</table>
	</t:formvalid>
...
<script src="webpage/safe/bop/bopS.js"></script>