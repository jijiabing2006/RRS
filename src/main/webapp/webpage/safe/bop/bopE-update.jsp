...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="bopEController.do?doUpdate" tiptype="1"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value" colspan="3" ><input id="custnm" name="custnm"
					type="text"  class="inputxt"  style="width:93%" datatype="*2-128"
			...
			<tr>
				<td align="left"><label class="Validform_label">
						收款人名称 </label></td>
				<td class="value" colspan="3"  ><input style="width:93%" id="oppuser"
					name="oppuser" type="text" class="inputxt"
