...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bopDController.do?doAdd" tiptype="1"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td align="left"><label class="Validform_label">
						收款人名称 </label></td>
				<td class="value"><input id="custnm" name="custnm"
			...
			<tr>
				<td align="left"><label class="Validform_label">
						付款人名称 </label></td>
				<td class="value"><input id="oppuser"
