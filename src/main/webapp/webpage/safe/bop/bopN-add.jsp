...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bopNController.do?doAdd" tiptype="1"
  beforeSubmit="check(curform,'N');">
					<input id="id" name="id" type="hidden" value="${bopNPage.id }">
					<input id="buscode" name="buscode" type="hidden" value="${bopNPage.buscode }">
					<input id="cap" name="cap" type="hidden" value="${bopNPage.cap }">
					<input id="brca" name="brca" type="hidden" value="${bopNPage.brca }">
					<input id="importdate" name="importdate" type="hidden" value="${bopNPage.importdate }">
					<input id="isdel" name="isdel" type="hidden" value="${bopNPage.isdel }">
					<input id="isedit" name="isedit" type="hidden" value="${bopNPage.isedit }">
					<input id="isexport" name="isexport" type="hidden" value="${bopNPage.isexport }">
					<input id="ishandadd" name="ishandadd" type="hidden" value="${bopNPage.ishandadd }">
					<input id="isvalidation" name="isvalidation" type="hidden" value="${bopNPage.isvalidation }">
					<input id="filename" name="filename" type="hidden" value="${bopNPage.filename }">
					<input id="isinsafe" name="isinsafe" type="hidden" value="${bopNPage.isinsafe }">
					<input id="tfilename" name="tfilename" type="hidden" value="${bopNPage.tfilename }">
					<input id="remark" name="remark" type="hidden" value="${bopNPage.remark }">
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="actiontype" type="list"
									typeGroupCode="actiontype" defaultVal="${bopNPage.actiontype}" hasLabel="false"  title="操作类型"></t:dictSelect>     
