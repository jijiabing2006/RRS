		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="actiondesc" name="actiondesc"
					...
					value='${bopRPage.actiondesc}" > <span
					class="Validform_checktip"></span></td>
				...
				<td class="value"><input id="rptno" name="rptno" type="text"
					...
					value='${bopRPage.rptno}" > <span class="Validform_checktip"></span>
				</td>
			</tr>

			<tr>
			<td align="left"><label class="Validform_label"> 收款性质 </label></td>
				<td class="value"><t:dictSelect field="paytype" type="list"
						typeGroupCode="paytype" defaultVal="${bopRPage.paytype}"
						hasLabel="false" title="收款性质" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
				
				<td align="left"><label class="Validform_label"> 境内收入类型</label></td>
				<td class="value"><t:dictSelect field="payattr" type="list"
						typeGroupCode="domesticpayattr" defaultVal="${bopRPage.payattr}"
						hasLabel="false" title="收入类型" datatype="*"></t:dictSelect> <span
					class="Validform_checktip"></span></td>
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="txcode" type="list"
						...
						dictText="text" defaultVal="${bopRPage.txcode}" hasLabel="false"
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="txcode2" type="list"
						dictTable="s_p_transcationcode where dir='1'" dictField="code"
						dictText="text" defaultVal="${bopRPage.txcode2}" hasLabel="false"
				...
				<td class="value"><input id="tc2amt" name="tc2amt" type="text"
					 class="inputxt" value="${bopRPage.tc2amt}" 
				...
				<td class="value"><input id="tx2rem" name="tx2rem" type="text"
					 class="inputxt" value="${bopRPage.tx2rem}" 
			...
			<tr>
				...
				<td class="value"><input id="crtuser" name="crtuser"
					...
					value='${bopRPage.crtuser}" > <span
					class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 填报人电话</label></td>
				<td class="value"><input id="inptelc" name="inptelc"
					type="text"  class="inputxt" datatype="*"
					value='${bopRPage.inptelc}" > <span
					class="Validform_checktip"></span></td>
				...
				<td class="value"><input id="rptdate" name="rptdate"
					...
					value='<fmt:formatDate value="${bopRPage.rptdate}"  type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span></td>
