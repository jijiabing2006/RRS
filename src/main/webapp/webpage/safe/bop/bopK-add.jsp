...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bopKController.do?doAdd" tiptype="1"
  beforeSubmit="check(curform,'K');">
					<input id="id" name="id" type="hidden" value="${bopKPage.id }">
					<input id="buscode" name="buscode" type="hidden" value="${bopKPage.buscode }">
					<input id="cap" name="cap" type="hidden" value="${bopKPage.cap }">
					<input id="brca" name="brca" type="hidden" value="${bopKPage.brca }">
					<input id="importdate" name="importdate" type="hidden" value="${bopKPage.importdate }">
					<input id="isdel" name="isdel" type="hidden" value="${bopKPage.isdel }">
					<input id="isedit" name="isedit" type="hidden" value="${bopKPage.isedit }">
					<input id="isexport" name="isexport" type="hidden" value="${bopKPage.isexport }">
					<input id="ishandadd" name="ishandadd" type="hidden" value="${bopKPage.ishandadd }">
					<input id="isvalidation" name="isvalidation" type="hidden" value="${bopKPage.isvalidation }">
					<input id="filename" name="filename" type="hidden" value="${bopKPage.filename }">
					<input id="isinsafe" name="isinsafe" type="hidden" value="${bopKPage.isinsafe }">
					<input id="tfilename" name="tfilename" type="hidden" value="${bopKPage.tfilename }">
					<input id="remark" name="remark" type="hidden" value="${bopKPage.remark }">
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="actiontype" type="list"
									typeGroupCode="actiontype" defaultVal="${bopKPage.actiontype}" hasLabel="false"  title="操作类型"></t:dictSelect>     
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="country" type="list"
									dictTable="s_p_countrycode" dictField="code " dictText="text" defaultVal="${bopKPage.country}" hasLabel="false"  title="收款人常驻国家地区代码"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="paytype" type="list"
									typeGroupCode="paytype" defaultVal="${bopKPage.paytype}" hasLabel="false"  title="付款性质"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							  <t:dictSelect field="txcode" type="list"
									dictTable="s_p_transcationcode where dir='2'" dictField="code" dictText="text" defaultVal="${bopKPage.txcode}" hasLabel="false"  title="交易编码1"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="txcode2" type="list"
									dictTable="s_p_transcationcode where dir='2'" dictField="code" dictText="text" defaultVal="${bopKPage.txcode2}" hasLabel="false"  title="交易编码2"></t:dictSelect>     
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="isref" type="list"
									typeGroupCode="sf_YN" defaultVal="${bopKPage.isref}" hasLabel="false"  title="是否保税货物项下"></t:dictSelect>     
							<span class="Validform_checktip"></span>
