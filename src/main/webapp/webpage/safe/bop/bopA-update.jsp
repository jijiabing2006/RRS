...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="bopAController.do?doUpdate" tiptype="1"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><t:dictSelect field="actiontype" type="list"
						typeGroupCode="actiontype" defaultVal="${bopAPage.actiontype}"
				...
				<td class="value"><input id="actiondesc" name="actiondesc"
					...
					value="${bopAPage.actiondesc}" > <span
					class="Validform_checktip"></span></td>
				...
				<td class="value"><input id="importdate" name="importdate"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value="${bopAPage.importdate}"  type="date" pattern="yyyy-MM-dd"/>'
			...
			<tr>
				...
				<td class="value" colspan="3"><input id="custnm" name="custnm"
					type="text" style="width: 95.5%" class="inputxt"
					value="${bopAPage.custnm}"  datatype="*2-128"> <span
					class="Validform_checktip"></span></td>
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="txccy" type="list"
						...
						defaultVal="${bopAPage.txccy}" hasLabel="false" title="收入款币种" datatype="*"></t:dictSelect>
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						收入款金额 </label></td>
				<td class="value"><input id="txamt" name="txamt" type="text"
					 class="inputxt" 
					value="${bopAPage.txamt}"  datatype="integer,sumge" with="lcyamt,fcyamt,othamt"> <span class="Validform_checktip"></span>
				</td>
				...
				<td class="value"><t:dictSelect field="method" type="list"
						...
						defaultVal="${bopAPage.method}" hasLabel="false" title="结算方式" datatype="*"></t:dictSelect>
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="left"><label class="Validform_label">
			...
			<tr>
				...
				<td class="value" colspan="5"><input id="oppuser"
					name="oppuser" type="text" style="width: 97%" class="inputxt"
					datatype="startJNJW" value="${bopAPage.oppuser}" > <span
					class="Validform_checktip"></span></td>
			</tr>
			...
			<tr>
				...
				<td class="value"><input id="lcyamt" name="lcyamt" type="text"
					 class="inputxt" value="${bopAPage.lcyamt}"  ignore="ignore" datatype="integer,linkcheck" with="lcyacc#empty#false,exrate#empty#false">
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						人民币帐号卡号 </label></td>
				<td class="value"><input id="lcyacc" name="lcyacc" type="text"
					 class="inputxt" value="${bopAPage.lcyacc}"  ignore="ignore" datatype="linkcheck" with="lcyamt#empty#false,exrate#empty#false">
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label"> 结汇汇率
				</label></td>
				<td class="value"><input id="exrate" name="exrate" type="text"
					 class="inputxt" value="${bopAPage.exrate}"  ignore="ignore" datatype="num,linkcheck" with="lcyamt#empty#false,lcyacc#empty#false">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				...
				<td class="value"><input id="fcyamt" name="fcyamt" type="text"
					 class="inputxt" value="${bopAPage.fcyamt}"  ignore="ignore" datatype="integer,bondcheck" with="fcyacc">
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						外汇帐号卡号 </label></td>
				<td class="value"><input id="fcyacc" name="fcyacc" type="text"
					 class="inputxt" value="${bopAPage.fcyacc}"  ignore="ignore" datatype="bondcheck" with="fcyamt">
					<span class="Validform_checktip"></span></td>
			...
			<tr>
				...
				<td class="value"><input id="othamt" name="othamt" type="text"
					 class="inputxt" value="${bopAPage.othamt}"  ignore="ignore" datatype="integer,bondcheck" with="othacc">
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						其它帐号卡号 </label></td>
				<td class="value"><input id="othacc" name="othacc" type="text"
					 class="inputxt" value="${bopAPage.othacc}"  ignore="ignore" datatype="bondcheck" with="othamt">
					<span class="Validform_checktip"></span></td>
			...
			<tr>
				...
				<td class="value"><input id="inchargeamt" name="inchargeamt"
					type="text" class="inputxt" value="${bopAPage.inchargeamt}"  ignore="ignore" datatype="integer,linkcheck" with="inchargeccy#empty#false" >
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						扣费币种 </label></td>
				<td class="value"><t:dictSelect field="inchargeccy" type="list"
						dictTable="normal_currency" dictField="currency" dictText="text"
						defaultVal="${bopAPage.inchargeccy}" ignore="ignore" datatype="bondcheck" with="inchargeamt"></t:dictSelect> <span
					class="Validform_checktip"></span></td>

			</tr>
			<tr>
				<td align="left"><label class="Validform_label"> 国外银行扣费金额
				</label></td>
				<td class="value"><input id="outchargeamt" name="outchargeamt"
					type="text" class="inputxt" value="${bopAPage.outchargeamt}"  ignore="ignore" datatype="integer,linkcheck" with="outchargeccy#empty#false" > 
					<span class="Validform_checktip"></span></td>
				<td align="left"><label class="Validform_label">
						扣费币种 </label></td>
				<td class="value"><t:dictSelect field="outchargeccy"
						type="list" dictTable="normal_currency" dictField="currency"
						dictText="text" defaultVal="${bopAPage.outchargeccy}" ignore="ignore" datatype="bondcheck" with="outchargeamt"></t:dictSelect>
					<span class="Validform_checktip"></span></td>
