...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:1px;">
		<t:datagrid name="fList" title="读取反馈"
			actionUrl="jshController.do?findFeedback" idField="id" fit="true"
			...
			<t:dgCol title="common.operation" field="opt"></t:dgCol>
			   <t:dgFunOpt  title="common.view"  funname="viewjsh(fbh_filename)" operationCode="view" />
...
<script type="text/javascript">
	...
	function readFeedback() {
		...
		doSubmitNunTable("jshController.do?readFeedback&date=" + d, "formobj");
	}
	function viewjsh(filename) {
	   var s=filename.substr(0,3);
	   var subtitle="账户内结售汇信息";
	   if(s=="JSH"){
		   subtitle="账户内结售汇信息";
	   }
//	addOneTab(subtitle, "accController.do?goaccupdate&type="+s+"&");
 //   update(subtitle,"accController.do?goaccupdate&load=detail","fList");
    detail(subtitle,"jshController.do?gojshupdate","fList");
	}
</script>