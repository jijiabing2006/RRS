...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jshGController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${jshGPage.id }">
					<input id="buscode" name="buscode" type="hidden" value="${jshGPage.buscode }">
					<input id="cap" name="cap" type="hidden" value="false">
					<input id="brca" name="brca" type="hidden" value="${jshGPage.brca }">
					<input id="parentbrca" name="parentbrca" type="hidden" value="${jshGPage.parentbrca }">
					<input id="isdel" name="isdel" type="hidden" value="${jshGPage.isdel }">
					<input id="isedit" name="isedit" type="hidden" value="${jshGPage.isedit }">
					<input id="isexport" name="isexport" type="hidden" value="${jshGPage.isexport }">
					<input id="ishandadd" name="ishandadd" type="hidden" value="${jshGPage.ishandadd }">
					<input id="isvalidation" name="isvalidation" type="hidden" value="${jshGPage.isvalidation }">
					<input id="filename" name="filename" type="hidden" value="${jshGPage.filename }">
					<input id="isinsafe" name="isinsafe" type="hidden" value="${jshGPage.isinsafe }">
					<input id="tfilename" name="tfilename" type="hidden" value="${jshGPage.tfilename }">
					<input id="remark" name="remark" type="hidden" value="${jshGPage.remark }">
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="actiontype" type="list"
									typeGroupCode="actiontype" defaultVal="${jshGPage.actiontype}" hasLabel="false"  title="操作类型"></t:dictSelect>     
