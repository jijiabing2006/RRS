...
<t:datagrid title="log.manage" name="logList" actionUrl="logController.do?datagrid" idField="id" sortName="operatetime" sortOrder="desc" pageSize="100"  >
...
<div id="logListtb" style="padding: 3px; height: 25px">
    ...
    <div name="searchColums" style="float: right; padding-right: 15px;">
        ...
        <select name="loglevel" id="loglevel" onchange="logListsearch();">
            ...
            <option value="6"><t:mutiLang langKey="common.exception"/></option>
