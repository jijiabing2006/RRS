...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" beforeSubmit="deleteUnUsedFiled();" layout="table" tiptype="1" action="cgFormHeadController.do?save">
	...
	<input id="isDbSynch" name="isDbSynch" type="hidden" value="${cgFormHeadPage.isDbSynch}">
	<input id="jformVersion" name="jformVersion" type="hidden" value="${cgFormHeadPage.jformVersion}">
