...
<t:formvalid formid="formobj" dialog="false" layout="div" action="demoController.do?saveDemo">
	<fieldset class="step">
	<div class="form"><label class="form"> 自动补全： </label> <t:autocomplete minLength="1" dataSource="commonController.do?getAutoList" closefun="open" valueField="id" searchField="userName,realName"
