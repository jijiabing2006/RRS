...
<t:formvalid formid="formobj" layout="div" dialog="true" action="##">
	<fieldset class="step"><t:dictSelect field="sex" typeGroupCode="sex" defaultVal="default" title="性别 Label"></t:dictSelect> 
	<t:dictSelect field="sex" typeGroupCode="sex" divClass="easyui-combobox"
