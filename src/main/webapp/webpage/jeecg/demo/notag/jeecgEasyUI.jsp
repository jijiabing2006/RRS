...
<script type="text/javascript" src="plug-in/Validform/js/Validform_v5.3.2_min_zh-cn.js"></script> <script type="text/javascript" src="plug-in/Validform/js/Validform_Datatype_zh-cn.js"></script> <script
