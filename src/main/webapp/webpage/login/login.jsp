...
<body>
                        ...
                        <div style="float: right; padding: 3px 0; margin-right: -12px;">
                            <div>
                                <ul class="uibutton-group">
                                    ...
                                    <li><a class="uibutton normal" href="#" id="but_reset"><t:mutiLang langKey="common.reset"/></a></li>
                                </ul>
                            </div>
                            <br>
                            <a href="#" id="forgetpass" onclick="javascript:$('#win').window('open')">忘记密码</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%--
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>Cathay United Bank</a> <t:mutiLang langKey="common.browser.recommend"/>:<a href="#" title=""/>IT部</a></span></div>
    </div>
    <!-- Link JScript-->
