...
<!DOCTYPE html >
<%
String browser = org.jeecgframework.core.util.BrowserUtils.checkBrowse(request);
%>
<html>
<head>
            ...
            <tr style="height: 25px;" align="right" >
                <td style="" colspan="2">
                   <div style="background: url(plug-in/login/images/top_bg.jpg) no-repeat right center; float: right;">
                    <div id="currinfo" style="float: left; line-height: 25px; margin-left: 70px;">
                        ...
                        <a id="currOrg" href="javascript:void(0);" title="切换当前机构" style="color: #FFFFFF;text-decoration:none;"  onclick="changeOrg()" on>${currentOrgName }</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="#" title="RRS -3">Cathay United Bank</a>
            <t:mutiLang langKey="common.browser"/>:
            <a href="#" title="<t:mutiLang langKey="common.browser.recommend"/>">  <%=browser %></a>
        </span>
    </div>
</div>
