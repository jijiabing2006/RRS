...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="http://www.jeecg.org" title="RRS -3">RRS-3</a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="RRS -3" href="http://www.jeecg.org">RRS -3</a></li>
</ul>
</div>
</footer>
